...
DATA_SIZES = [20000]
scores_knn = []
filenameTXT = "resultadoLogisticR.txt"
filenamePNG = "learningcurveLogisticR.png"
name = "LogisticR"
...
# Plotar o gráfico
# plt.figure()
# plt.plot(DATA_SIZES, scores_knn, marker='o', label="LogisticR")

# plt.xlabel("Training set size")
# plt.ylabel("Accuracy")
# plt.title("Learning Curve - LogisticR")
# plt.legend()
# plt.grid()

...
with open("resultadoKNN7.3.txt", "a") as f:
    #start = time.time()
    for N in DATA_SIZES:
        ...
        # f.write("Classification Report (k-NN=7):\n")
...
# Plotar o gráfico
# plt.figure()
# plt.plot(DATA_SIZES, scores_knn, marker='o', label="KNN")

# plt.xlabel("Training set size")
# plt.ylabel("Accuracy")
# plt.title("Learning Curve - KNN - 7")
# plt.legend()
# plt.grid()

# plt.savefig("learning_curveKNN7.png")  # 👈 isso resolve
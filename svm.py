...
scores_knn = []
filenameTXT = "resultadoSVMParameters.txt"
filenamePNG = "learningcurveSVMParameters.png"
name = "SVMParameters"
...
clf = SVC(
    ...
    C=1.0,          # regularização
    gamma='scale'   # controle da influência dos pontos
)
...
# # Plotar o gráfico
# plt.figure()
# plt.plot(DATA_SIZES, scores_knn, marker='o', label="SVM-parameters")

# plt.xlabel("Training set size")
# plt.ylabel("Accuracy")
# plt.title("Learning Curve - SVM - parameters")
# plt.legend()
# plt.grid()

...
scores_knn = []
filenameTXT = "resultadoDecisionTreeParameters.txt"
filenamePNG = "learningcurveDecisionTreeParameters.png"
...
# # Plotar o gráfico
# plt.figure()
# plt.plot(DATA_SIZES, scores_knn, marker='o', label="DecisionTreeParameters")

# plt.xlabel("Training set size")
# plt.ylabel("Accuracy")
# plt.title("Learning Curve - DecisionTree - parameters")
# plt.legend()
# plt.grid()
